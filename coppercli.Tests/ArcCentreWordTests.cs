...
namespace coppercli.Tests
{
    ...
    /// legal, and whether it maps to the arc's first or second axis, depends on the plane in
    /// force. A wrong mapping cuts an arc around the wrong center at feed rate. All nine
    /// combinations are covered, because the mapping is a table.
    /// </summary>
    public class ArcCentreWordTests
    {
        ...
        public void ACentreWord_MapsToItsPlanesAxis(
        ...
        [InlineData("G19", "I3")]
        [InlineData("G18", "J3")]
        public void TheAxisWordOutsideThePlane_IsRefused(string planeWord, string centreWord)
        {
